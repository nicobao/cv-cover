...
\social[github]{nicobao}

% Add social links to letter header (they're omitted by default in moderncv)
% Solution from: https://tex.stackexchange.com/questions/256794
\makeatletter
\patchcmd{\makeletterhead}% patch to add social links
  {\ifthenelse{\isundefined{\@extrainfo}}{}{\makenewline\@extrainfo}}% search after extrainfo line
  {\ifthenelse{\isundefined{\@extrainfo}}{}{\makenewline\@extrainfo}%
   \collectionloop{socials}{% add social links here
     \makenewline\csname\collectionloopkey socialsymbol\endcsname\collectionloopitem}%
  }% replace
  {}{}% success/failure (empty means silent)
